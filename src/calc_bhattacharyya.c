...
dipole_tf (const vector3d *obs, const source *s)
{
	...
	if (!obs) error_and_exit ("dipole_tf", "vector3d *obs is empty.", __FILE__, __LINE__);
	if (!s) error_and_exit ("dipole_tf", "source *s is empty.", __FILE__, __LINE__);
	...
	while (cur) {
		...
		if (!cur->pos) error_and_exit ("dipole_tf", "position of source item is empty.", __FILE__, __LINE__);
		if (!cur->mgz) error_and_exit ("dipole_tf", "magnetization of source item is empty.", __FILE__, __LINE__);
...
prism_tf (const vector3d *obs, const source *s)
{
	...
	if (!obs) error_and_exit ("prism_tf", "vector3d *obs is empty.", __FILE__, __LINE__);
	if (!s) error_and_exit ("prism_tf", "source *s is empty.", __FILE__, __LINE__);
	...
	while (cur) {
		...
		if (!cur->pos) error_and_exit ("prism_tf", "position of source item is empty.", __FILE__, __LINE__);
		if (!cur->dim) error_and_exit ("prism_tf", "dimension of source item is empty.", __FILE__, __LINE__);
		if (!cur->mgz) error_and_exit ("prism_tf", "magnetization of source item is empty.", __FILE__, __LINE__);
